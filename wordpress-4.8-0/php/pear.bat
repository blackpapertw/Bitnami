@ECHO OFF                                                                                                     
									SET "PHP_PEAR_SYSCONF_DIR=C:\Bitnami\wordpress-4.8-0\php"
...
FOR %%x IN ("C:\Bitnami\wordpress-4.8-0\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Bitnami\wordpress-4.8-0\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Bitnami\wordpress-4.8-0\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Bitnami\wordpress-4.8-0\php\php.exe"
